                    ...
                    children: [
                              ...
                              customFunction: (() {
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: ((context) =>
                                            SeeAllArticlesPage(
                                                covid19Category: ArticleFunctions.getArticlesByCategory(articles, 'Covid-19'),
                                                healthCategory: ArticleFunctions.getArticlesByCategory(articles, 'Health'),
                                                lifestyleCategory:
                                                    ArticleFunctions.getArticlesByCategory(articles, 'Lifestyle'),
                                                medicalCategory:
                                                    ArticleFunctions.getArticlesByCategory(articles, 'Medical')))));
                              }))
                        ],
                      ),
                      SizedBox(
                      ...
                      Expanded(
                        child: TabBarView(
                          ...
                          children: [
                            MyListArticles(
                              articles: ArticleFunctions.getArticlesByCategory(articles, 'Medical'),
                            ),
                            MyListArticles(
                              articles: ArticleFunctions.getArticlesByCategory(articles, 'Health'),
                            ),
                            MyListArticles(
                              articles: ArticleFunctions.getArticlesByCategory(articles, 'Covid-19'),
                            ),
                            MyListArticles(
                              articles: ArticleFunctions.getArticlesByCategory(articles, 'Lifestyle'),
                            ),
                          ],
                        ),
                      ),
