...
import 'package:my_health_assistant/src/views/admin/dashboard.dart';
import 'package:my_health_assistant/src/views/admin/patient_screen.dart';
import 'package:my_health_assistant/src/views/admin/topic_screen.dart';
